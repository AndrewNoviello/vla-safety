"""dino_wm/inference.py — Inference module for the DINO World Model.
...
Usage as a library:
    from dino_wm.inference import DinoWMInference
    inf = DinoWMInference()
    z_obses, wm_visual = inf.rollout(obs_0, all_actions)

Standalone sanity check:
    python -m dino_wm.inference [--hf-repo REPO] [--checkpoint FILE] [--device DEVICE]
"""
