...
class Leader(Node):
    def __init__(self):
        super().__init__(node_name="piplup_leader")
        self.pub_real = self.create_publisher(msg_type=Float64MultiArray, topic="piplup/joint_command", qos_profile=10)
        ...
        leader_config = SO101LeaderConfig(id="piplup_leader", port="/dev/ttyACM1", calibration_dir=Path("/home/Shared/calibration/teleoperators/so101_leader"))
